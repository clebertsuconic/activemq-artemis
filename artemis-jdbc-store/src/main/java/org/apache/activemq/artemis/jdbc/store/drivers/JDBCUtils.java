...
public class JDBCUtils {
    ...
    */
   public static void createTable(JDBCConnectionProvider connectionProvider,
                                  String tableName,
   ...
   public static void createTable(Connection connection,
      ...
      try {
         ...
         if (tableExists) {
            ...
            try (Statement statement = connection.createStatement(); ResultSet cntRs = statement.executeQuery(sqlProvider.getCountJournalRecordsSQL(tableName))) {
