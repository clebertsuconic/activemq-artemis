...
public class PropertySQLProvider implements SQLProvider {
   ...
   @Override
   public Factory.SQLDialect getDialect() {
      return dialect;
   }
   ...
   @Override
   public String[] getCreateParallelDBAddress(String tableName) {
      return new String[] {
         format(sql("create-parallelDB-address"), tableName)
      };
   }

   @Override
   public String[] getCreateParallelDBQueue(String tableName) {
      return new String[] {
         format(sql("create-parallelDB-queue"), tableName)
      };
   }
