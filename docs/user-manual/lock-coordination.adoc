...
----
<lock-coordinators>
   <lock-coordinator name="kube-lock">
      <class-name>org.apache.artemis.lock.kube.KubeLockManager</class-name>
      <lock-id>artemis-ha-lock</lock-id>
      <check-period>5000</check-period>

      <properties>
         <property key="namespace" value="artemis-namespace"/>
         <property key="lease-timeout" value="30"/>
      </properties>
   </lock-coordinator>
</lock-coordinators>
----
