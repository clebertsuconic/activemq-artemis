...
ARTEMIS_HOME='/work/apache/six/artemis-distribution/target/apache-artemis-2.6.0-SNAPSHOT-bin/apache-artemis-2.6.0-SNAPSHOT'
ARTEMIS_INSTANCE='/work/apache/six/artemis-distribution/target/apache-artemis-2.6.0-SNAPSHOT-bin/apache-artemis-2.6.0-SNAPSHOT/bin/broker1'
ARTEMIS_DATA_DIR='/work/apache/six/artemis-distribution/target/apache-artemis-2.6.0-SNAPSHOT-bin/apache-artemis-2.6.0-SNAPSHOT/bin/broker1/data'
ARTEMIS_ETC_DIR='/work/apache/six/artemis-distribution/target/apache-artemis-2.6.0-SNAPSHOT-bin/apache-artemis-2.6.0-SNAPSHOT/bin/broker1/etc'

# The logging config will need an URI
# this will be encoded in case you use spaces or special characters
# on your directory structure
ARTEMIS_INSTANCE_URI='file:/work/apache/six/artemis-distribution/target/apache-artemis-2.6.0-SNAPSHOT-bin/apache-artemis-2.6.0-SNAPSHOT/bin/broker1/'
ARTEMIS_INSTANCE_ETC_URI='file:/work/apache/six/artemis-distribution/target/apache-artemis-2.6.0-SNAPSHOT-bin/apache-artemis-2.6.0-SNAPSHOT/bin/broker1/etc/'
