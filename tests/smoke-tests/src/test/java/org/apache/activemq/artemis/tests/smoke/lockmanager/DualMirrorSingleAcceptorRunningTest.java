...
public class DualMirrorSingleAcceptorRunningTest extends SmokeTestBase {
   ...
   public void testAlternatingFile() throws Throwable {
      ...
      properties.put("acceptorConfigurations.artemis.leaderManager", "failover");
      ...
      properties.put("leadManagerConfigurations.failover.checkPeriod", "5000");
      properties.put("leadManagerConfigurations.failover.leadType", "file");
      properties.put("leadManagerConfigurations.failover.lockId", "fail");
      properties.put("leadManagerConfigurations.failover.name", "failover");
      properties.put("leadManagerConfigurations.failover.properties.locks-folder", fileLock.getAbsolutePath());
