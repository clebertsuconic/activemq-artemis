...
public class StarMirrorSingleAcceptorRunningTest extends SmokeTestBase {
   ...
   private static void createServerTrio(String serverNameA, String serverNameB, String serverNameC,
      ...
      createSingleServer(serverLocationC, configPathC, "C", customizeServer);
   }
   ...
   public void testAlternatingZK() throws Throwable {
      {
         createServerTrio(SERVER_NAME_WITH_ZK_A, SERVER_NAME_WITH_ZK_B, SERVER_NAME_WITH_ZK_C,
   ...
   public void testAlternatingFile() throws Throwable {
      ...
      {
         createServerTrio(SERVER_NAME_WITH_FILE_A, SERVER_NAME_WITH_FILE_B, SERVER_NAME_WITH_FILE_C,
