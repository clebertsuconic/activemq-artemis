...
public class RegistryTest extends ActiveMQTestBase {
   ...
   public void testRegistry() {
      ...
      assertInstanceOf(FileBasedLockManagerFactory.class, factory);
      ...
      assertInstanceOf(CuratorDistributedLockManagerFactory.class, factory);
