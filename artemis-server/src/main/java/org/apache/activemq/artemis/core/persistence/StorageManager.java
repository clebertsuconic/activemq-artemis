...
public interface StorageManager extends MapStorageManager, IDGenerator, ActiveMQComponent {
   ...
   default GlobalMemoryManager getGlobalMemoryManager() {
      return null;
   }
    ...
    * journal
    */
   boolean addToPage(AddressMemoryManager store, Message msg, Transaction tx, RouteContextList listCtx) throws Exception;
