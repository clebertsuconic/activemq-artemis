...
public class InsertAddressStatement extends BatchableStatement<AddressData> {
   ...
   public InsertAddressStatement(Connection connection, JDBCConnectionProvider connectionProvider, DatabaseStorageConfiguration databaseStorageConfiguration, int expectedSize) throws SQLException {
   ...
   private static String getSQL(JDBCConnectionProvider connectionProvider, DatabaseStorageConfiguration databaseStorageConfiguration) {
      ...
      return "INSERT INTO ADDRESS_INFO (ADDRESS_ID, ADDRESS_NAME, IS_MULTICAST, IS_ANYCAST) VALUES (?, ?, ?, ?)";
   }
