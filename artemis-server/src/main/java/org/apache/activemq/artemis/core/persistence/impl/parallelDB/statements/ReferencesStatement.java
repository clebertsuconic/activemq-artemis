...
public class ReferencesStatement extends BatchableStatement<MessageReferenceData> {
   ...
   public ReferencesStatement(Connection connection, JDBCConnectionProvider connectionProvider, DatabaseStorageConfiguration databaseStorageConfiguration, int expectedSize) throws SQLException {
