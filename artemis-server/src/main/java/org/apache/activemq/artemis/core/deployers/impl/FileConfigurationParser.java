...
public final class FileConfigurationParser extends XMLConfigurationUtil {
   ...
   private void parseLeadManager(final Element leadElement, final Configuration mainConfig) throws Exception {
      ...
      LeadManagerConfiguration leadManagerConfiguration = new LeadManagerConfiguration().setName(name).setLockId(lockId).setType(leadType).setCheckPeriod(checkPeriod).setProperties(properties);
      mainConfig.addLeadManagerConfiguration(name, leadManagerConfiguration);
   }
