...
/**
 * Token implementation for queue quota with automatic rollback.
 */
class QueueQuotaTokenImpl implements QueueQuotaToken {

   private final ResourceQuota quota;
   private volatile boolean committed = false;

   QueueQuotaTokenImpl(ResourceQuota quota) {
      this.quota = quota;
   }
