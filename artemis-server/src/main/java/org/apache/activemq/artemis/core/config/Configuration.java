...
public interface Configuration {
   ...
   Collection<LeadManagerConfiguration> getLeadManagerConfigurations();

   void addLeadManagerConfiguration(String leadName, LeadManagerConfiguration configuration);
