...
public class LeadManagerConfiguration {
   ...
   public LeadManagerConfiguration setName(String name) {
   ...
   public LeadManagerConfiguration setLockId(String lockId) {
   ...
   public LeadManagerConfiguration setType(String type) {
   ...
   public LeadManagerConfiguration setCheckPeriod(int checkPeriod) {
      if (checkPeriod <= 0) {
   ...
   public LeadManagerConfiguration setProperties(Map<String, String> properties) {
