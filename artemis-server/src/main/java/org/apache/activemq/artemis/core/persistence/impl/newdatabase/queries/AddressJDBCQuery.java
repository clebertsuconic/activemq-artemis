...
public class AddressJDBCQuery {
   ...
   public AddressJDBCQuery(Connection connection) {
   ...
   public void query(Consumer<AddressData> consumer) throws Exception {
      ...
      try (ResultSet resultSet = statement.executeQuery("SELECT ADDRESS_ID, ADDRESS_NAME, IS_MULTICAST, IS_ANYCAST FROM ADDRESS_INFO ORDER BY ADDRESS_ID")) {
