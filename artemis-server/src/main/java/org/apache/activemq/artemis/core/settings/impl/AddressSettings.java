...
public class AddressSettings implements Mergeable<AddressSettings>, Serializable, EncodingSupport {
   ...
   public static final long DEFAULT_MAX_HIERARCHICAL_MESSAGES = -1;

   public static final long DEFAULT_MAX_HIERARCHICAL_BYTES = -1;

   public static final HierarchicalFullPolicy DEFAULT_HIERARCHICAL_FULL_POLICY = HierarchicalFullPolicy.NO_CHECK;
   ...
   static {
      metaBean.add(Long.class, "maxHierarchicalMessages", (t, p) -> t.maxHierarchicalMessages = p, t -> t.maxHierarchicalMessages);
   }
   private Long maxHierarchicalMessages = null;

   static {
      metaBean.add(Long.class, "maxHierarchicalBytes", (t, p) -> t.maxHierarchicalBytes = p, t -> t.maxHierarchicalBytes);
   }
   private Long maxHierarchicalBytes = null;
   ...
   public long getMaxHierarchicalMessages() {
      return Objects.requireNonNullElse(maxHierarchicalMessages, AddressSettings.DEFAULT_MAX_HIERARCHICAL_MESSAGES);
   }

   public AddressSettings setMaxHierarchicalMessages(final long maxHierarchicalMessages) {
      this.maxHierarchicalMessages = maxHierarchicalMessages;
      return this;
   }

   public long getMaxHierarchicalBytes() {
      return Objects.requireNonNullElse(maxHierarchicalBytes, AddressSettings.DEFAULT_MAX_HIERARCHICAL_BYTES);
   }

   public AddressSettings setMaxHierarchicalBytes(final long maxHierarchicalBytes) {
      this.maxHierarchicalBytes = maxHierarchicalBytes;
      return this;
   }
   ...
   public boolean equals(Object obj) {
      ...
      return Objects.equals(addressFullMessagePolicy, other.addressFullMessagePolicy) &&
             ...
             Objects.equals(maxHierarchicalMessages, other.maxHierarchicalMessages) &&
             Objects.equals(maxHierarchicalBytes, other.maxHierarchicalBytes) &&
