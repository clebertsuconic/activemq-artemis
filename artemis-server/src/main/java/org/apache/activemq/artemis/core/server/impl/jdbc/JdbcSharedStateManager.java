...
final class JdbcSharedStateManager extends AbstractJDBCDriver implements SharedStateManager {
   ...
   private JdbcSharedStateManager(JDBCConnectionProvider connectionProvider, String tableName, String holderId, long lockExpirationMillis, long queryTimeoutMillis, long allowedTimeDiff) {
   ...
   public static JdbcSharedStateManager usingConnectionProvider(String holderId,
                                                                ...
                                                                SQLProvider provider,
                                                                String tableName) {
      final JdbcSharedStateManager sharedStateManager = new JdbcSharedStateManager(connectionProvider, tableName, holderId, locksExpirationMillis,
