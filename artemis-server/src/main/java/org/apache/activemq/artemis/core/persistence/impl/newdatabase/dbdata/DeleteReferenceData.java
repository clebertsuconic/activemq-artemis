...
public class DeleteReferenceData extends DBData<DataWorker> {
   public long queueID;
   public long messageID;

   public DeleteReferenceData(long queueID, long messageID, IOCompletion context) {
      super(context, true);
   ...
   public String toString() {
      return "DeleteReferenceData{" + "queueID=" + queueID + ", messageID=" + messageID + '}';
   }
}