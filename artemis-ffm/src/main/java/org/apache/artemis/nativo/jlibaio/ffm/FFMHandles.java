...
public class FFMHandles {
   ...
   static final MethodHandle FCNTL_HANDLE = LINKER.downcallHandle(STDLIB.find("fcntl").orElseThrow(() -> new UnsatisfiedLinkError("fcntl not found in STDLIB")), FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG));
